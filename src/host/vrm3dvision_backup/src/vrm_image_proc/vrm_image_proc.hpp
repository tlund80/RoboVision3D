...
enum class sequence_state {
	...
	READY = 0,
	START = 1,
	GO_TO_SCAN_POSITION = 2,
	FIND_OBJECT = 3,
	PRE_PICK_UP = 4,
	PICK_UP = 5,
	POST_PICK_UP = 6,
	PRE_DELIVER_OBJECT = 7,
	DELIVER_OBJECT = 8,
	POST_DELIVER_OBJECT = 9,
	DONE = 10
};
...
namespace vrm3dvision {
	...
	class VrmImageProc
	{
		...
		private:
			...
			ros::ServiceServer acquireSequenceOnRobotSrv_;
			ros::ServiceServer computeBestExposureSrv_;
			...
			actionlib::SimpleActionClient<control_msgs::FollowJointTrajectoryAction>* robot_action_client_;
			control_msgs::FollowJointTrajectoryGoal joint_trajectory_;
			...
			// Robot control
			bool allow_robot_control_;
			sequence_state seq_state_;
			std::string sequence_save_path_;
			std::ofstream save_results_ap;
			std::ofstream save_results_h;
			std::string pose_estimate_model_;
			std::string exposure_for_pose_;
