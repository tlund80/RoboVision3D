...
#include <dense_reconstruction/DisparityConfig.h>
...
class DisparityNodelet : public nodelet::Nodelet
{
  ...
  typedef dense_reconstruction::DisparityConfig Config;
...
{
	NODELET_INFO("Image pair received!!");
...
PLUGINLIB_DECLARE_CLASS(dense_reconstruction, disparity,
						dense_reconstruction::DisparityNodelet, nodelet::Nodelet)
