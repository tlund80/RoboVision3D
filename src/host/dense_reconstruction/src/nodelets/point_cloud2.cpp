                                 ...
                                 const DisparityImageConstPtr& disp_msg)
{
  ...
  ROS_INFO("point size %d",  (int)points_msg->data.size());
...
PLUGINLIB_DECLARE_CLASS(dense_reconstruction, point_cloud2,
						dense_reconstruction::PointCloud2Nodelet, nodelet::Nodelet)
