...
namespace vrm3dvision {
	...
	class StructuredLightReconstruction
	{
		...
		private:
			...
			void updateEncodedImage(CamInfo& cam_info, int bit_level, int cam);
			...
			bool JEPP_Interpolate(double& offset, int row, int col, const CamInfo& cam_info, int index, std::vector<int>& edge_values);
