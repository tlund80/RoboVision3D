...
**
** Created: Mon Apr 7 12:41:49 2014
...
public:
    ...
    void setupUi(QDockWidget *SensorsPlugin)
    {
        ...
        _btnSave = new QPushButton(dockWidgetContents);
        _btnSave->setObjectName(QString::fromUtf8("_btnSave"));

        verticalLayout_2->addWidget(_btnSave);
    ...
    {
        SensorsPlugin->setWindowTitle(QApplication::translate("SensorsPlugin", "ROS_Sensor", 0, QApplication::UnicodeUTF8));
        btnDisplay->setText(QApplication::translate("SensorsPlugin", "Display Sensor", 0, QApplication::UnicodeUTF8));
        _btnSave->setText(QApplication::translate("SensorsPlugin", "Save Image", 0, QApplication::UnicodeUTF8));
